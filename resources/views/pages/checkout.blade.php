                ...
                <div class="order-detail-content">
                  <div class="table-responsive">
                    <table class="table table-bordered cart_summary">
                      ...
                      <tbody>
                        <tr>
                          <td class="cart_product"><a href="#"><img src="source/images/products/img01.jpg" alt="Product"></a></td>
                        ...
                        <tr>
                          <td class="cart_product"><a href="#"><img src="source/images/products/img02.jpg" alt="Product"></a></td>
                          <td class="cart_description"><p class="product-name"><a href="#">Ipsums Dolors Untra </a></p>
                        ...
                        <tr>
                          <td class="cart_product"><a href="#"><img src="source/images/products/img03.jpg" alt="Product"></a></td>
                          <td class="cart_description"><p class="product-name"><a href="#">Ipsums Dolors Untra </a></p>
